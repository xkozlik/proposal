...
The task of the biochemists is to assess the plausibility of a multidocking complex.% (see Figure \ref{fig:multidocking}).
...
\subsection{Stage 3: Formalization of Visual Analysis Systems}
...
Therefore, a drill down into relevant subparts of the highly structured data must by done with typical database queries but with a strong domain semantic from our application area. 
