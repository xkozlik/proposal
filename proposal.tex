...
\begin{center}
\includegraphics[width=0.5\textwidth,height=0.5\textwidth]{pics/system.png}
\end{center}
...
\begin{wrapfigure}{l}{0.55\textwidth}
  \begin{center}
  \includegraphics[width=0.55\textwidth,height=0.48\textwidth]{pics/telomer.png}
	\end{center}
	\vspace{-20pt}
...
\begin{wrapfigure}{l}{0.49\textwidth}
  \begin{center}
  \includegraphics[width=0.49\textwidth]{pics/parallel.png}
	\end{center}
...
\begin{wrapfigure}{l}{0.48\textwidth}
  \begin{center}
  \includegraphics[width=0.48\textwidth]{pics/varshney.png}
	\end{center}
